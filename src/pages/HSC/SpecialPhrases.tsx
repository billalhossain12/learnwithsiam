...
export default function SpecialPhrases() {
  ...
  // Filter logic
  const filteredData = specialPhrasesData.filter((item) => {
    const boardMatch =
            ...
            <div key={`${item.board}-${item.year}-${index}`} className="mb-12">
              <div className="flex items-center flex-wrap gap-2 mb-3">
                <h2 className="text-lg font-semibold text-gray-800">
                  Complete the sentences with suitable phrases/words given in
                  the box
                </h2>
              ...
              {/* Questions */}
              <ul className="list-[lower-alpha] pl-5 space-y-2 mb-4 text-gray-800">
                ...
                items={[
                  {
                    ...
                    label: "Show Answer",
                    children: (
                      <ul className="list-[lower-alpha] pl-5 space-y-1 font-semibold text-gray-700">
